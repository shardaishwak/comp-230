...
def createInitialData(cursor):
    ...
    address_id3 = createAddress(cursor, "789 Maple Ave", "Glasgow", "67890", "UK")
    ...
    user_id2 = createUser(cursor, name="Jane Smith", gender="FEMALE", date_of_birth="1965-05-12", address_id=address_id2)
    ...
    taxi_id1 = createTaxi(cursor, owner_id=owner_id1, registration_number="ABW123", capacity=4)
    taxi_id2 = createTaxi(cursor, owner_id=owner_id2, registration_number="XYZ789", capacity=6)
    taxi_id3 = createTaxi(cursor, owner_id=owner_id1, registration_number="DEF456", capacity=4)
